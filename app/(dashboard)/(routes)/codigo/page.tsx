...
const CodigoPage = () => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try {
           ...
           const response = await axios.post("/api/codigo", { messages: newMessages,
        });
    ...
    return (
        <div>
            <Heading
            title = "Gerar Código"
            description = "Gerar códigos de programação"
            icon={Code}
                                ...
                                <FormItem className="col-span-12 lg:col-span-10">
                                    <FormControl className="m-0 p-0">
                                        <Input 
                                          ...
                                          disabled={isLoading}
                                          placeholder="Gere um exemplo de código HTML para criar um cabeçalho (header) de página da web"
                                          {...field}
                                        />
                                    </FormControl>
                                </FormItem>
